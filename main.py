...
if __name__ == "__main__":
    ...
    layout = [
            [sg.Text("Kevin's Ghetto Bot", size=(60,1), font=('Comic sans ms', 20), text_color='red')],
            [sg.Text("Enter Username"), sg.Input()],
            [sg.Text("Enter Password"), sg.Input()],
            [sg.Text("Enter URL"), sg.Input()],
            [sg.Text("Enter Shoe Size"), sg.Input()],
            [sg.Text("Enter Shoe Type"), sg.Input()],
            [sg.Text("Enter CVV"), sg.Input()],
            [sg.Text("Enter Shipping Option"), sg.Input()],
            [sg.Text("Enter Shipping Address"), sg.Input()],
            [sg.Text("Enter Login Time"), sg.Input()],
            [sg.Text("Enter Release Time"), sg.Input()],
            [sg.Text("Enter Screenshot Path"), sg.Input()],
            [sg.Text("Enter HTML Path"), sg.Input()],
            [sg.Text("Enter Page Load Timeout"), sg.Input()],
            [sg.Text("Enter Driver Type"), sg.Input()],
            [sg.Text("Enter Headless"), sg.Input()],
            [sg.Text("Enter Payment"), sg.Input()],
            [sg.Text("Purchase"), sg.Input()],
            [sg.Text("Enter Number of Retries"), sg.Input()],
            [sg.Text("You gonna quit?"), sg.Input()],
            [sg.Button("Submit")]
    ]

    # Create the window
    window = sg.Window("Kevin's Shoe Bot", layout)
    ...
    while True:
        ...
        window['-OUTPUT-'].update('Values submitted ' + "! Good luck bitch.")
